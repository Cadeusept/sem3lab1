...
void print(const std::vector<Student>& students, std::ostream& os) {
    unsigned max_name = 0; unsigned max_group = 0;
    unsigned max_avg = 0; unsigned max_debt = 0;
    ...
    os << table_string;
    os << "|" << std::left << std::setw(max_name) << "Name" << "|"
        << std::setw(max_group) << "Group" << "|"
        << std::setw(max_avg) << "Avg" << "|"
        << std::setw(max_debt) << "Debt" << "|\n";
